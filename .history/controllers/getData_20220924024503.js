...
const getScientists = (req, res) => {
    ...
    .then(response => {
        ...
        $('article.feature', html).each(function() {
            ...
            const birthday = $('div.desc-q:nth-chlild(1)', this).text()
            const birthplace = $('div.desc-q:nth-chlild(1)', this).text()
            const died = $('div.desc-q:nth-chlild(1)', this).text()
            const sign = $('div.desc-q:nth-chlild(1)', this).text()
